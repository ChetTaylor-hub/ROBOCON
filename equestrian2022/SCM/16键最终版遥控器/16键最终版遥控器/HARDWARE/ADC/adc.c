...
{ 	
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA |RCC_APB2Periph_GPIOC |RCC_APB2Periph_ADC1 |RCC_APB2Periph_ADC2, ENABLE );	  //使能ADC1通道时钟
...
u16 Get_Adc_Average(u8 ad,u8 ch,u8 times)
{
	u32 temp_val=0;
	u8 t;
	for(t=0;t<times;t++)
	{
		temp_val+=Get_Adc(ad,ch);
		delay_us(10);
	}
