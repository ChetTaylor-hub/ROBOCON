...
if __name__ == '__main__':
    src = cv2.imread('pics/1E715A608429BA7929AA1C1DAAD105FD.jpg', cv2.IMREAD_GRAYSCALE)
    src = cv2.resize(src, [2000, 1500])
    temp = cv2.imread('template2.jpg', cv2.IMREAD_GRAYSCALE)
