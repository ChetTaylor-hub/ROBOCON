...
# Form implementation generated from reading ui file 'ball_1.ui'
#
...
class Ui_Camshow(QtWidgets.QOpenGLWidget):
    def setupUi(self, Camshow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(310, 140, 961, 621))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.camerLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
    ...
    def retranslateUi(self, Camshow):
        ...
        self.groupBox.setTitle(_translate("Camshow", "GroupBox"))
