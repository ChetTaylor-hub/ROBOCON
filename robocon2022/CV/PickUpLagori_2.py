...
if __name__ == '__main__':
    ...
    #light_process = Thread(target=send_UART, args=())
    #light_process.start()
    ...
    while cap.isOpened():
        ...
        '''中心点校准模式'''
        center_circle_blue_x, center_circle_blue_y, area= detect_circle(frame, blue_lower, blue_upper)
        ...
        center_circle_red_x, center_circle_red_y, area = detect_circle(frame, red_lower, red_upper)
